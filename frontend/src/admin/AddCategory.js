...
const AddCategory = () => {
        ...
        return(
            <form>
                <div className="form-group">
                    ...
                    <input type="text" className="form-control my-3" onChange={handleChange} value={name} autoFocus required placeholder="For Ex. Paediatrics"/>
    ...
    return (
        <Base title="Create Category" description="Add a new category here" className="container bg-info p-4">
             {goBack()}
